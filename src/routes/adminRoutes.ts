...
} from "../controllers/adminOfflineOrderController";
import {
...
router.use(protect, restrictToAdminPanel);
...
router.use(requireAdminApiAccess);
...
router.get(
  "/ai/daily-brief",
  adminAiLimiter,
  validate(adminAiBriefQuerySchema),
  ...getAdminDailyBrief,
);
router.get(
...
router.get(
  "/ai/explain/order/:orderId",
  adminAiLimiter,
  validate(adminAiOrderIdSchema),
  ...explainAdminOrder,
);
router.get(
  "/ai/explain/user/:userId",
  adminAiLimiter,
  validate(adminAiUserIdSchema),
  ...explainAdminUser,
);
...
router.post(
  "/ai/draft/product",
  adminAiLimiter,
  validate(adminAiProductDraftSchema),
  ...draftAdminProductCopy,
);
router.post(
  "/ai/draft/catalog-seo",
  adminAiLimiter,
  validate(adminAiCatalogSeoDraftSchema),
  ...draftAdminCatalogSeo,
);
router.post(
  "/ai/draft/review/:reviewId",
  adminAiLimiter,
  validate(adminAiReviewIdSchema),
  ...draftAdminReviewReply,
);
router.post(
  "/ai/draft/marketing-email",
  adminAiLimiter,
  validate(adminAiMarketingDraftSchema),
  ...draftAdminMarketingEmail,
);
router.post(
  "/ai/draft/promotion-terms",
  adminAiLimiter,
  validate(adminAiPromotionTermsSchema),
  ...draftAdminPromotionTerms,
);
router.post(
  "/ai/draft/blog",
  adminAiLimiter,
  validate(adminAiBlogDraftSchema),
  ...draftAdminBlogPost,
);
router.post(
  "/ai/blog-calendar/plan",
  adminAiLimiter,
  validate(adminAiBlogCalendarSchema),
  ...planAdminBlogCalendar,
);
router.post(
  "/ai/ask",
  adminAiLimiter,
  validate(adminAiAskSchema),
  ...askAdminStore,
);
...
router.get(
  "/products/search",
  validate(adminProductSearchQuerySchema),
  searchAdminProducts,
);
router.get(
  "/products/:id",
  validate(adminProductIdParamSchema),
  getAdminProductById,
);
...
router.get(
  "/orders/:id/delhivery/pin-check",
  validate(delhiveryOrderIdParamsSchema),
  checkOrderPinServiceability,
);
router.post(
  "/orders/:id/delhivery/estimate",
  validate(delhiveryEstimateSchema),
  estimateDelhiveryForOrder,
);
router.post(
  "/orders/:id/delhivery/create-shipment",
  validate(delhiveryCreateShipmentSchema),
  createDelhiveryShipmentForOrder,
);
router.post(
  "/orders/:id/delhivery/sync-tracking",
  validate(delhiveryOrderIdParamsSchema),
  syncDelhiveryTrackingForOrder,
);
router.get(
...
router.post(
  "/emails/send",
  adminSensitiveLimiter,
  validate(sendMarketingEmailSchema),
  sendCustomMarketingEmail,
);
...
router.get(
  "/inventory",
  validate(inventoryOverviewQuerySchema),
  getInventoryOverview,
);
router.get("/inventory/export", exportInventoryHandler);
router.patch(
  "/inventory/products/:id/variants/:sku/stock",
  adminSensitiveLimiter,
...
router.get(
  "/operating-expenses",
  validate(operatingExpenseListQuerySchema),
  listOperatingExpensesHandler,
);
router.get(
  "/operating-expenses/summary",
  validate(operatingExpenseSummaryQuerySchema),
  getOperatingExpenseSummaryHandler,
);
router.post(
  "/operating-expenses",
  adminSensitiveLimiter,
  validate(createOperatingExpenseSchema),
  createOperatingExpenseHandler,
);
router.put(
  "/operating-expenses/:id",
  adminSensitiveLimiter,
  validate(updateOperatingExpenseSchema),
  updateOperatingExpenseHandler,
);
router.delete(
  "/operating-expenses/:id",
  adminSensitiveLimiter,
  validate(operatingExpenseIdParamsSchema),
  voidOperatingExpenseHandler,
);
