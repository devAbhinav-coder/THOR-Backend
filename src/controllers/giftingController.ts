...
import {
  respondToQuote,
  updateGiftingRequestAdmin,
} from "../services/gifting/giftingQuoteService";
...
export const getGiftCategoriesHandler = catchAsync(
...
export const getMyGiftingRequests = catchAsync(
  async (req: AuthRequest, res: Response) => {
    ...
    const { requests, total } = await listMyGiftingRequests(
      String(req.user?._id),
      page,
      limit,
    );
