...
export const listOperatingExpensesHandler = catchAsync(async (req: Request, res: Response) => {
...
export const getOperatingExpenseSummaryHandler = catchAsync(async (req: Request, res: Response) => {
...
export const voidOperatingExpenseHandler = catchAsync(async (req: AuthRequest, res: Response) => {
