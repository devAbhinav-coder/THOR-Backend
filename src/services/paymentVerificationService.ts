  ...
  async finalizePaymentIntent(
    ...
    await withOptionalTransaction(async (session) => {
      ...
      const orderPayload = {
        ...
        saleDiscount: snap.saleDiscount ?? 0,
        promotionDiscount: snap.promotionDiscount ?? 0,
        couponDiscount: snap.couponDiscount ?? 0,
        ...(snap.promotion ? { promotion: snap.promotion } : {}),
        ...(snap.shopSessionKey ? { shopSessionKey: snap.shopSessionKey } : {}),
