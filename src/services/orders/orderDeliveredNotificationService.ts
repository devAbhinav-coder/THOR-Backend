...
/**
 * Send delivered + tax invoice email once per order (idempotent).
 * Full invoice goes as PDF attachment — email body stays short (no clipping).
 * Skips customers without a real email (offline POS placeholders, etc.).
 */
