...
export async function recordCartMutationAttempt(userId: string, ip: string): Promise<void> {
...
export async function isCartMutationThrottled(userId: string, ip: string): Promise<boolean> {
