...
export type OrderNotificationTone =
  "order" | "promotion" | "alert" | "info" | "success" | "error" | "system";
...
export function getOnlineOrderPlacedCopy(
  orderNumber: string,
...
export function getOnlineOrderPaidCopy(
  orderNumber: string,
): OrderNotificationCopy {
  return {
...
export function getOfflineHandoverCopy(
  orderNumber: string,
): OrderNotificationCopy {
  return {
...
export function getOfflineShipLaterCopy(
  orderNumber: string,
): OrderNotificationCopy {
  return {
...
export function getOrderDeliveredCopy(
  orderNumber: string,
): OrderNotificationCopy {
  return {
...
export function getOrderCancelledByAdminCopy(
  orderNumber: string,
): OrderNotificationCopy {
  return {
    title: `Order cancelled - ${orderNumber}`,
