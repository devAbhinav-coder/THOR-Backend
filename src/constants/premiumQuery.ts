...
export const PREMIUM_PRODUCT_SELECT =
  "name slug premiumSlug premiumSubtitle description shortDescription category subcategory fabric careInstructions highlights occasions tags price comparePrice images premiumHeroImage craftNote weaveHours premiumEditorialOpen premiumEditorialClose variants.size variants.color variants.colorCode variants.stock variants.sku variants.price totalStock isActive isPremium isCustomizable isGiftable minOrderQty customFields sortOrderPremium ratings viewCount soldCount productDetails motionVideoUrl motionVideoPublicId motionReelUrl seoTitle seoDescription hsnCode createdAt updatedAt";
...
export const PREMIUM_CACHE_SHAPE_VERSION = 5;
